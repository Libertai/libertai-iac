...
function push {
	...
	# Record the cid of the model
	jq ".\"${MODEL_NAME}\" .sqfs_cid=${MODEL_SQFS_CID}" models.json >models.json.tmp
	jq ".\"${MODEL_NAME}\".sqfs_item_hash=${MODEL_SQFS_ITEM_HASH}" models.json.tmp >models.json
	mv models.json.tmp models.json
}
